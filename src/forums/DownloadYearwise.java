...
*/
        ...
        try {
            ...
            while (currPage <= numPages) {
                ...
                while (currPageData.contains("<a href=\"/users/")) {
                    ...
                    adjMatrix.put(currUser, topicStarter, val); /*duplication is incorrect*/
                    numUsersPerTopic++;
	...
	String FORUMID = args[0];
        ...
        try {
            FileReader topicURLs = new FileReader("year/" + FORUMID + ".csv");
            ...
            adjMatCSV.close();
            FileWriter topicLengthFile = new FileWriter("centrality/topicLength" + FORUMID + ".csv");
